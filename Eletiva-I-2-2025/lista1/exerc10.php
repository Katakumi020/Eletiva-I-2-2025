...
<title>Exercício 10 da lista 1</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" >
</head>
<body> 
<div class="container">
<h1>Exercício 10 da lista 1</h1>
<form method="post">
<div class="mb-3">
...
<?php
    ...
    $numero_formatado = number_format($area, 0, '', '.');
    echo "<p> O perimetro do retângulo é: $numero_formatado m² </p>";//flamengo
    }
    ?>
